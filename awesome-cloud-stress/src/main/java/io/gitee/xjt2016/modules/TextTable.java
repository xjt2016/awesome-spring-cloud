...
public class TextTable {
     ...
     * expanded later.
     *
     * @param width  width of table including border columns
     * @param height height of table including border rows
     */
     ...
     * will be trunctated.
     *
     * @param line    line to insert content at
     * @param index   index to insert content at
     ...
     *
     * @param style style to apply to border.
     */
     ...
     *
     * @param line  line to apply style to
     * @param style style to apply to line
     */
     ...
     * @param index  index, where style should start
     * @param length length of styled content
     * @param style  style to apply to region
     */
     ...
     * @param formatted text to apply style to
     ...
     *
     * @param index line to get content of
    ...
    public String toString() {
        ...
        for (StringBuilder builder : this.lines) {
            table.append(builder.toString()).append("\n");
        }
